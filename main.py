...
def game_opening():
    ...
    draw_status() # It draws a black rectangle where we update the status of the game

# Defining draw_status function
def draw_status():
    global draw
...
# Drawing the 'X' and 'O' mark on the grid
def drawXO(row,col):
    global TTT, XO
    if row==1:
        posx = 30
...
# User Click function - Mouse Click
def userClick():
